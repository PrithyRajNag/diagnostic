        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Create Schedule</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form id="createForm" class="form form-vertical" action="{{route('schedule.store')}}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="day" class="mb-2 d-flex align-items-center">Day</label>
                                                <select class=" form-select select2"  style="width: 100%" name="day" >
                                                    <option  value=""></option>
                                                    <option value="saturday"  @if (old('day') == 'saturday') selected="selected"  @endif>Saturday</option>
                                                    <option value="sunday" @if (old('day') == 'sunday') selected="selected" @endif>Sunday</option>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="per_patient_time" class="mb-2">{{'Per Patient Time '}} &nbsp;
                                                    ( {{'In Minutes'}} )</label>
                                                <input type="number" min="0" class="form-control" id="per_patient_time" name="per_patient_time" value="{{ old('per_patient_time') }}">
                                            </div>
