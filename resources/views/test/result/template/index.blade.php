                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12">
                            <h2>Test Report Template List</h2>
                            <div class="d-flex justify-content-end text-right">
                                <a href="{{route('test-report-template.create')}}"
                                ...
                                <form id="delForm" method="POST" style="width: 100%">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center font-bold">
                                            Are you sure want to Delete? It will REVERSIBLY delete all Test Item records of that Test Category.
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            $('#laravel_datatable').DataTable({
                ...
                serverSide: true,
                "order": [[0, "desc"]],
                ajax: "{{route('test-report-template.index') }}",
                columns: [
                    // {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                    {data: 'test_item_id', name: 'test_item_id'},
