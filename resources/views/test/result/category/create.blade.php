        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Create Test Result Category</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form id="createForm" class="form form-vertical" action="{{route('test-result-category.store')}}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <textarea class="form-control" name="reference" rows="2">{{ old('reference') }}</textarea>
