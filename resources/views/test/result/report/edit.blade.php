        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Edit Test Report</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" id="editForm" action="{{route('test-report.update', $report->uuid)}}"
                                  method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                                        ...
                                        <hr/>
                                        <input type="text" id="pid" name="pid" hidden value="{{ $report->pid }}">
                                    </div>
                                    <div class="mb-2 p-2">
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice_no"
                                                           name="invoice_number"
                                                           value="{{ $report->invoice_number ?? old('invoice_no') }}"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="first_name" class="mb-2"><span class="required">*</span>
                                                        First Name</label>
                                                    <input type="text" class="form-control" id="first_name" value="{{ $report->first_name }}"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="last_name" class="mb-2"><span class="required">*</span>
                                                        Last Name</label>
                                                    <input type="text" class="form-control" id="last_name" value="{{ $report->last_name }}"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="phone_number"
                                                           name="phone_number" value="{{ $report->phone_number ?? old('phone_number') }}"
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="invoice_date"
                                                           name="invoice_date" value="{{ $report->invoice_date ?? old('invoice_date') }}"
                                                           readonly
                                                    >
                                                </div>
                                                <span
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" id="delivery_date"
                                                           name="delivery_date" value="{{ $report->delivery_date ?? old('delivery_date') }}">
                                                </div>
                                                <span
                                    ...
                                    <div class="mb-2 p-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="test_item_id" id="test_item_id" class="form-control select2"
                                                        ...
                                                        @foreach($items as $item)
                                                            <option hidden value="{{old('test_item_id', $item->id)}}" {{$report->test_item_id == $item->id ? 'selected' : ''}}>{{$item->test_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <span
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="report_name" class="mb-2"><span class="required">*</span>
                                                        Report Name</label>
                                                    <input type="text" class="form-control" id="report_name" value="{{ $report->report_name }}"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="status"
                                                               id="procession"
                                                               value="PROCESSING" {{($report->status == "PROCESSING") ? "checked" : ""}}
                                                        required>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="status"
                                                               id="done"
                                                               value="DONE" {{($report->status == "DONE") ? "checked" : ""}}
                                                        required>
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="status"
                                                               id="delivered"
                                                               value="DELIVERED" {{($report->status == "DELIVERED") ? "checked" : ""}}
                                                        required>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <textarea name="report" id="data" hidden>{{ $report->report }}</textarea>
                                                    <div id="toolbar"></div>
                                                    <div id="editor" ></div>
                                                </div>
                                            </div>
