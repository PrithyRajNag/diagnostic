        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Edit Blood Output</h3>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                           <form class="form form-vertical" action="{{route('blood-input.output', $data->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="is_patient" class="form-select" required>
                                                    <option hidden
                                                            value="{{ $data->is_patient?? '' }}"> {{ ucfirst($data->is_patient) ?? ''}}</option>
