        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Create Blood Output</h3>
                            <div class="d-flex justify-content-end">
                                <a href="{{route('blood-output.index')}}" class="btn-sm btn-primary">BACK</a>
                            </div>
                            <hr/>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="{{route('blood-output.store')}}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <fieldset class="form-group">
                                                <label for="is_patient" class="mb-2">Our Patient</label>
                                                <select name="is_patient" class="form-select" required>
                                                    <option value="{{ old('is_patient') }}" hidden></option>
                                                    <option value="true"
                                                            @if (old('is_patient') == 'true') selected="selected" @endif>
                                                        Yes
                                                    </option>
                                                    <option value="false"
                                                            @if (old('is_patient') == 'false') selected="selected" @endif>
                                                        No
                                                    </option>
                                                </select>
                                            </fieldset>
                                            <span
                                                class="text-danger">@error('is_patient'){{ $message }}@enderror</span>
                                        </div>
