                    ...
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-12 col-sm-12">
                                 <h2 class="text-capitalize">Blood Donor List</h2>
                                 <div class="d-flex justify-content-end text-right">
                                     <a href="{{route('blood-donor.create')}}" class="btn btn-sm btn-primary text-center text-uppercase">Create New Blood Donor</a>
                                 </div>
                                <hr/>
                            </div>
                        </div>
