        ...
        <div class="card-content">
            <div class="card-body">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12 col-xs-12 order-md-1 order-last ">
                            <h3 class="text-capitalize">Create Investigation Report</h3>
                            <div class="d-flex justify-content-end">
                                <a href="{{route('investigation-report.index')}}" class="btn-sm btn-primary">BACK</a>
                            </div>
                            <hr/>
                        </div>
                    </div>
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical" action="{{route('investigation-report.store')}}" method="POST">
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="image" class="mb-2">Picture</label>
