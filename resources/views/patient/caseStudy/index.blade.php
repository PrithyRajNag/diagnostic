                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12">
                            <h2>Patient Case Study List</h2>
                            <div class="d-flex justify-content-end text-right">
                                <a href="{{route('patient-case-study.create')}}"
                                   class="btn btn-sm btn-primary text-center text-uppercase">Create New Patient Case Study</a>
                            </div>
                            <hr/>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#laravel_datatable').DataTable({
            ...
            serverSide: true,
            "order": [[0, "desc"]],
            ajax: "{{route('patient-case-study.index') }}",
            columns: [
                {data: 'DT_RowIndex', name: 'DT_RowIndex'},
                {data: 'patient_id', name: 'patient_id'},
                {data: 'food_allergies', name: 'food_allergies'},
                {data: 'tendency_bleed', name: 'tendency_bleed'},
                {data: 'heart_disease', name: 'heart_disease'},
                {data: 'high_blood_pressure', name: 'high_blood_pressure'},
                {data: 'diabetic', name: 'diabetic'},
