                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical"
                                  action="{{route('appointment.update', $appointment->uuid)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="patient_id"
                                                       class="mb-2 d-flex align-items-center">PID</label>
                                                <select name="patient_id" class="form-select select2"
                                                        style="width: 100%" disabled>
                                                    <option hidden
                                                            value="">{{old('patient_id', $appointment->patients->pid ?? '')}}</option>
                                                    @foreach($patients as $patient)
                                                        <option
                                                            value="{{ $patient->id }}" {{$appointment->patient_id == $patient->id ? "selected" : '' }}>{{ $patient->pid }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="first_name"
                                                       value="{{$appointment->patients->first_name}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="last_name"
                                                       value="{{$appointment->patients->last_name}}"
                                                       name="last_name" required readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="phone_no" class="mb-2"><span class="required">*</span> Phone
                                                    Number</label>
                                                <input type="text" class="form-control" id="phone_no"
                                                       value="{{$appointment->patients->phone_no}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="age"
                                                       value="{{$appointment->patients->age}}"
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="gender"
                                                       value="{{ucfirst($appointment->patients->gender)}}"
                                                       name="gender" required readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                <label for="doctor_type" class="mb-2 d-flex align-items-center">Doctor
                                                    Type</label>
                                                <select id="doctor_type" class="form-control select2"
                                                        style="width: 100%">
                                                    <option hidden
                                                            value="{{ $appointment->doctors->user_type ?? '' }}">{{ $appointment->doctors->user_type ?? '' }}</option>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <fieldset class="form-group">
                                                ...
                                                <select name="department_id" id="department_id"
                                                        class="department form-select select2" style="width: 100%"
                                                        disabled>
                                                    <option hidden
                                                            value="{{$appointment->doctors->departments->title ?? ''}}">{{$appointment->doctors->departments->title ?? ''}}</option>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <fieldset class="form-group">
                                                <label for="doctor_id" class="mb-2 d-flex align-items-center">Doctor
                                                    Name</label>
                                                <select name="doctor_id" id="doctor_id"
                                                        class="doctor form-select select2" style="width: 100%" disabled>
                                                    <option hidden
                                                            value="{{ $appointment->doctors->id ?? '' }}">{{ $appointment->doctors->full_name ?? '' }}</option>
                                                </select>
                                            </fieldset>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            ...
                                            <span
                                                class="text-danger">@error('appointment_date'){{ $message }}@enderror</span>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <input class="form-check-input form-check-success" type="radio"
                                                           name="schedule_id" value="{{$appointment->schedule_id}}"
                                                           checked>
                                                    <label class="form-check-label"
                                                           for="schedule_id">{{date('h:i a', strtotime($appointment->schedules->start_time)) . ' - '. date('h:i a', strtotime($appointment->schedules->end_time)) }}</label>
            ...
            fetch(`/appointment/get-slot/${doctor}/${today}`)
                ...
                .then(res => {
                    ...
                    if (res.length === 0) {
                        ...
                        $("#slots").html(res.map((slot) => `<div class="form-check check-time"><input class="form-check-input form-check-success" type="radio" name="schedule_id" id="schedule_id" value="${slot.id}" required><label class="form-check-label" >${tConvert(slot.start_time) + ' - ' + tConvert(slot.end_time)}</label></div><input type="radio" name="appointment_time" id="appointment_time" value="${tConvert(slot.start_time) + ' - ' + tConvert(slot.end_time)}" >`).join(' '))
                    }
