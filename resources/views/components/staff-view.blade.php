...
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        <label for="joining_date" class="mb-2"><span class="required">*</span>
            Joining Date</label>
        <input type="date" class="form-control take_past_date" id="joining_date"
...
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="present_address[country]"
               ...
               value="{{old('present_address[country]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="present_address[district]"
               id="present_district"
               class="form-control"
               value="{{old('present_address[district]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="present_address[upazila]" id="present_upazila"
               class="form-control"
               value="{{old('present_address[upazila]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="present_address[post_code]" id="present_post"
               class="form-control"
               value="{{old('present_address[post_code]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
...
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="permanent_address[country]"
               ...
               class="form-control"
               value="{{old('permanent_address[country]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="permanent_address[district]"
               ...
               class="form-control"
               value="{{old('permanent_address[district]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="permanent_address[upazila]"
               ...
               class="form-control"
               value="{{old('permanent_address[upazila]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="permanent_address[post_code]"
               id="permanent_post"
               class="form-control"
               value="{{old('permanent_address[post_code]')}}">
    </div>
</div>
<div class="col-sm-12 col-md-6">
    <div class="form-group">
...
<input type="text"
       value="STAFF" class="form-control" id="user_type" name="user_type"
       hidden>
