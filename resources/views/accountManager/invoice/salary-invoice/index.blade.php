                ...
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12">
                            <h2>{{'Salary Invoice List'}}</h2>
                            <div class="d-flex justify-content-end text-right">
                                <a href="{{route('salary-invoice.create')}}"
                                   class="btn btn-sm btn-primary text-center text-uppercase">{{'Create New Salary Invoice'}}</a>
                            </div>
                            <hr/>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#laravel_datatable').DataTable({
            ...
            serverSide: true,
            "order": [[0, "desc"]],
            ajax: "{{route('salary-invoice.index') }}",
            columns: [
