                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 col-sm-12">
                            ...
                            <div class="d-flex justify-content-end text-right">
                                <a href="{{route('medicine-category.create')}}"
                                   class="btn btn-sm btn-primary text-center text-uppercase">Create New Medicine Category</a>
                            </div>
                            <hr/>
                        </div>
                    </div>
...
<script>
    $(document).ready(function () {
        $('#laravel_datatable').DataTable({
            ...
            serverSide: true,
            "order": [[0, "desc"]],
            ajax: "{{route('medicine-category.index') }}",
            columns: [
